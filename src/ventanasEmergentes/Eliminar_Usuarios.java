...
public class Eliminar_Usuarios extends La_Ventana_Emergente_Abstract {
	AdministrarUsuarios administrarUsuarios;

	public Eliminar_Usuarios(AdministrarUsuarios administrarUsuarios) {
	...
	public void agregarBotones() {
		...
		Eliminar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				administrarUsuarios.eliminarUsuariosSeleccionados();
				dispose();
			}
		});
	...
	public void anadirIcono() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(Eliminar_Usuarios.class.getResource("/img/alerta.png")));
	...
	public void anadirTexto() {
		{
			...
			txtpnestSeguroQue.setText("Eliminar miembros\r\n");
			txtpnestSeguroQue.setBounds(154, 127, 217, 44);
